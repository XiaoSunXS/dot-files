...
- [files/.gitconfig](https://github.com/XiaoSunXS/dot-files/blob/master/files/.gitconfig)
- [clone_and_link.sh](https://github.com/XiaoSunXS/dot-files/blob/master/clone_and_link.sh#L10)

## Usage

    bash <(curl -fsS https://raw.githubusercontent.com/XiaoSunXS/dot-files/master/clone_and_link.sh)
